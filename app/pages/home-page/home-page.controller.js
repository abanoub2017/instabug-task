...
angular.module('appModule').controller('homeController', homePageController).value('FiltersComponent', FiltersComponent);
...
function homePageController(Employees) {
  ...
  function searchFunction(searchKeyword) {
    ...
    homePageVm.employees = homePageVm.employees.filter((employee) => {
      return employee.profile.name.toLowerCase().includes(searchKeyword.toLowerCase());
    });
  }
